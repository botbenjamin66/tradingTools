...
dataObjects = {"msciValue": dataFactory().createData("file", "msciValue", "2023-01-01", "2023-11-24", "1d", "msciValue.xlsx", 8),
                ...
                "msciDividends": dataFactory().createData("file", "msciDivi", "2023-01-01", "2023-11-24", "1d", "msciDivi.xlsx", 8),
                "msciMinimumvola": dataFactory().createData("file", "msciMinvol", "2023-01-01", "2023-11-24", "1d", "msciMinvol.xlsx", 8),

                "msciCommunication": dataFactory().createData("file", "msciCommunication", "2023-01-01", "2023-11-24", "1d", "msciCommunication.xlsx", 8),
                "msciConsumerdiscretionary": dataFactory().createData("file", "msciConsumerdiscretionary", "2023-01-01", "2023-11-24", "1d", "msciConsumerdiscretionary.xlsx", 8),
                "msciConsumerstaples": dataFactory().createData("file", "msciConsumerstaples", "2023-01-01", "2023-11-24", "1d", "msciConsumerstaples.xlsx", 8),
                "msciEnergy": dataFactory().createData("file", "msciEnergy", "2023-01-01", "2023-11-24", "1d", "msciEnergy.xlsx", 8),
                "msciFinancials": dataFactory().createData("file", "msciFinancials", "2023-01-01", "2023-11-24", "1d", "msciFinancials.xlsx", 8),
                "msciHealthcare": dataFactory().createData("file", "msciHealthcare", "2023-01-01", "2023-11-24", "1d", "msciHealthcare.xlsx", 8),
                "msciIndustrials": dataFactory().createData("file", "msciIndustrials", "2023-01-01", "2023-11-24", "1d", "msciIndustrials.xlsx", 8),
                "msciInformationtech": dataFactory().createData("file", "msciInformationtech", "2023-01-01", "2023-11-24", "1d", "msciInformationtech.xlsx", 8),
                "msciMaterials": dataFactory().createData("file", "msciMaterials", "2023-01-01", "2023-11-24", "1d", "msciMaterials.xlsx", 8),
                "msciRealestate": dataFactory().createData("file", "msciRealestate", "2023-01-01", "2023-11-24", "1d", "msciRealestate.xlsx", 8),
                "msciUtilities": dataFactory().createData("file", "msciUtilities", "2023-01-01", "2023-11-24", "1d", "msciUtilities.xlsx", 8)}
...
# PERFORMACE AROUND SPECIFIED DATES
