# add pattern, trail1, trail2, endDate, startDate, signalBlock, triggerPrice & minMaxMcap TO plot for alpha
# improve dash : plot last signal, only show signals in last xDays
